...
class MemoryStoreTool(BaseTool):
    ...
    def __init__(self, memory_path: Optional[str] = None):
        ...
        self.memory_path = memory_path or os.path.join(os.path.expanduser("~"), ".llm_agents", "memory.db")
        os.makedirs(os.path.dirname(self.memory_path), exist_ok=True)
        self._init_db()
        
        logger.info(f"Initialized tool: memory_store with database at {self.memory_path}")
    ...
    async def _execute(self, key: str, value: Any, namespace: str = "default",
                     ttl: int = 0, tags: List[str] = None, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            cursor.execute('DELETE FROM memories WHERE expires_at IS NOT NULL AND expires_at < ?', (current_time,))
            ...
            # Get the memory ID
            cursor.execute('SELECT id FROM memories WHERE key = ? AND namespace = ?', (key, namespace))
            ...
            if tags:
                for tag in tags:
                    cursor.execute('INSERT INTO memory_tags (memory_id, tag) VALUES (?, ?)', (memory_id, tag))
...
class MemoryRetrieveTool(BaseTool):
    ...
    def __init__(self, memory_path: Optional[str] = None):
        ...
        logger.info(f"Initialized tool: memory_retrieve with database at {self.memory_path}")
    ...
    async def _execute(self, key: str, namespace: str = "default", **kwargs) -> Dict[str, Any]:
...
class MemorySearchTool(BaseTool):
    ...
    def __init__(self, memory_path: Optional[str] = None):
        ...
        logger.info(f"Initialized tool: memory_search with database at {self.memory_path}")
    ...
    async def _execute(self, query_type: str, query: str, limit: int = 10, **kwargs) -> Dict[str, Any]:
...
class KnowledgeBaseTool(BaseTool):
    ...
    def __init__(self, kb_path: Optional[str] = None):
        ...
        self._parameters = {
            "operation": {
                ...
                "enum": ["add_fact", "query_facts", "add_relationship", "query_relationships"],
                "default": "query_facts"
            },
            "entity": {
                "type": "string",
            ...
            "attribute": {
                "type": "string",
                "description": "Attribute name for fact"
            },
            "value": {
                "type": "string",
        ...
        self.kb_path = kb_path or os.path.join(os.path.expanduser("~"), ".llm_agents", "knowledge.db")
    ...
    def _init_db(self) -> None:
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_relationships_entity ON relationships(entity)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_relationships_relation ON relationships(relation)')
    ...
    async def _execute(self, operation: str, entity: Optional[str] = None,
                      attribute: Optional[str] = None, value: Optional[str] = None,
                      relation: Optional[str] = None, target: Optional[str] = None,
