...
class ChartGeneratorTool(BaseTool):
    ...
    async def _execute(self, chart_type: str, data: Dict[str, Any], title: Optional[str] = None,
                      x_label: Optional[str] = None, y_label: Optional[str] = None,
                      colors: Optional[List[str]] = None, width: float = 10, 
                      height: float = 6, dpi: int = 100, **kwargs) -> Dict[str, Any]:
    ...
    def _generate_bar_chart(self, data: Dict[str, Any], title: Optional[str] = None,
                           x_label: Optional[str] = None, y_label: Optional[str] = None,
    ...
    def _generate_line_chart(self, data: Dict[str, Any], title: Optional[str] = None,
                            x_label: Optional[str] = None, y_label: Optional[str] = None,
                            colors: Optional[List[str]] = None) -> None:
        ...
        if 'series' in data:
            ...
            for i, series in enumerate(series_data):
                ...
                if len(x_values) != len(y_values):
                    raise ValueError(f"Number of x values must match y values in series {i+1}")
    ...
    def _generate_pie_chart(self, data: Dict[str, Any], title: Optional[str] = None,
                           colors: Optional[List[str]] = None) -> None:
    ...
    def _generate_scatter_chart(self, data: Dict[str, Any], title: Optional[str] = None,
                               x_label: Optional[str] = None, y_label: Optional[str] = None,
                               colors: Optional[List[str]] = None) -> None:
        ...
        if 'groups' in data:
            ...
            for i, group in enumerate(groups_data):
                ...
                if len(x_values) != len(y_values):
                    raise ValueError(f"Number of x values must match y values in group {i+1}")
    ...
    def _generate_histogram(self, data: Dict[str, Any], title: Optional[str] = None,
                           x_label: Optional[str] = None, y_label: Optional[str] = None,
                           colors: Optional[List[str]] = None) -> None:
...
class HeatmapGeneratorTool(BaseTool):
    ...
    def __init__(self):
        super().__init__(
            ...
            description="Generate heatmaps from matrix data"
        )
        self._parameters = {
            "data": {
                "type": "array",
    ...
    async def _execute(self, data: List[List[float]], title: Optional[str] = None,
                      x_labels: Optional[List[str]] = None, y_labels: Optional[List[str]] = None,
                      colormap: str = "viridis", show_values: bool = True,
                      width: float = 10, height: float = 8, dpi: int = 100, **kwargs) -> Dict[str, Any]:
                ...
                for i in range(matrix.shape[0]):
                    for j in range(matrix.shape[1]):
                        text = plt.text(j, i, f"{matrix[i, j]:.2f}",
                                      ha="center", va="center", color="w" if matrix[i, j] > np.mean(matrix) else "black")
