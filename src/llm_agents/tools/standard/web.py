...
class HTTPRequestTool(BaseTool):
    ...
    async def _execute(self, url: str, method: str = "GET", headers: Dict[str, str] = None, 
                      data: Any = None, params: Dict[str, str] = None, 
                      timeout: float = 30, **kwargs) -> JSON:
...
class WebScraperTool(BaseTool):
    ...
    async def _execute(self, url: str, selectors: List[Dict[str, Any]] = None,
                      extract_text: bool = True, extract_links: bool = False,
                      extract_images: bool = False, extract_metadata: bool = True,
