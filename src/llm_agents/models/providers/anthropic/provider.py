...
class AnthropicProvider:
    ...
    async def create_model(self, model_name: str, parameters: Optional[ModelParameters] = None) -> BaseModel:
        ...
        return ClaudeModel(model_name=model_name, client=self.client, parameters=parameters)

class AnthropicModel(BaseModel):
    def __init__(self, model_name: str, api_key: str, trace_provider: Optional[TraceProvider] = None):
    ...
    async def _prepare_messages(self, messages: List[Message]) -> List[Dict]:
        ...
        with self._create_span("format_messages", {
    ...
    async def count_tokens(self, text: str) -> int:
        ...
        import tiktoken
        with self._create_span("count_tokens", {
