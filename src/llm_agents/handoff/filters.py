...
def remove_sensitive_information(input_data: HandoffInputData) -> HandoffInputData:
    ...
    filtered_system = redact_text(input_data.system_message) if input_data.system_message else None
...
def preserve_context(input_data: HandoffInputData, max_messages: int = 5) -> HandoffInputData:
    """
    ...
    recent_messages = input_data.conversation_history[-max_messages:] if input_data.conversation_history else []
