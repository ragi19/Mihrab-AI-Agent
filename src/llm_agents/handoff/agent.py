...
class HandoffAgent:
    ...
    async def process(self, 
                     ...
                     handoff_chain: Optional[List[str]] = None) -> Union[str, Tuple[str, Dict[str, Any]]]:
        """
    ...
    def _should_handoff(self, message: str, handoff: HandoffConfig, context: Optional[Dict[str, Any]] = None) -> bool:
        """
        ...
        keywords = {
            "technical": ["error", "bug", "broken", "not working", "help with", "how to", "fix", "troubleshoot"],
            "billing": ["payment", "invoice", "charge", "refund", "price", "cost", "subscription", "plan"],
            "scheduling": ["schedule", "appointment", "book", "meeting", "when", "time", "calendar", "availability"],
            "research": ["research", "information", "data", "analysis", "study", "investigate", "find out"],
            "legal": ["legal", "law", "regulation", "compliance", "terms", "policy", "agreement", "contract"],
            "sales": ["purchase", "buy", "order", "product", "service", "pricing", "discount", "deal"]
        }
