...
def keyword_based_condition(keywords: List[str]) -> Callable[[str, Dict[str, Any]], bool]:
    """
...
def complexity_based_condition(threshold: int = 20, technical_terms: List[str] = None) -> Callable[[str, Dict[str, Any]], bool]:
    """
...
def sentiment_based_condition(negative_terms: List[str] = None) -> Callable[[str, Dict[str, Any]], bool]:
    """
    ...
    negative_terms = negative_terms or [
        ...
        "awful", "horrible", "bad", "worst", "complaint", "issue", "problem"
    ]
...
def topic_based_condition(topics: Dict[str, List[str]]) -> Callable[[str, Dict[str, Any]], bool]:
    """
