...
class HandoffAgent:
    ...
    def _should_handoff(self, message: str, handoff: HandoffConfig) -> bool:
        ...
        keywords = {
            "technical": ["error", "bug", "broken", "not working", "help with", "how to"],
            "billing": ["payment", "invoice", "charge", "refund", "price", "cost"],
            "scheduling": ["schedule", "appointment", "book", "meeting", "when", "time"]
        }
...
class HandoffMultiAgentSystem:
    ...
    async def process_query(self, query: str) -> str:
        ...
        try:
            response = await self.agents["general"].process(query, session_id="handoff_session")
