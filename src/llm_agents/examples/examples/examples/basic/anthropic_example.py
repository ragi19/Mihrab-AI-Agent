...
async def main():
    ...
    # Run a conversation
    messages = [
        Message(role=MessageRole.SYSTEM, content="You are Claude, a helpful AI assistant."),
        Message(role=MessageRole.USER, content="What are the main challenges in artificial intelligence today?")
    ]
