...
class ModelProfiler:
    ...
    async def profile_model(self, provider_name: str, model_name: str, questions: List[str]):
        """
    ...
    def compare_models(self):
        ...
        print("\n=== Model Comparison ===")
        print(f"{'Provider':<12} {'Model':<20} {'Success':<10} {'Avg Time':<10} {'Avg Tokens':<12}")
        print("-" * 70)
        ...
        for model_key, metrics in self.results.items():
            ...
            print(f"{provider:<12} {model:<20} {success_rate:<10} {avg_time:<10} {avg_tokens:<12}")
